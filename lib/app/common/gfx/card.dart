...
class GFXCard extends StatelessWidget {
  ...
  /// [GFXPosition] titlePosition helps to set titlebar at top of card
  final GFXPosition? titlePosition;
  ...
  /// The title to display inside the GFXTitleBar. see GFXTitleBar
  final GFXListTile? title;
  ...
  /// widget can be used to define buttons bar, see [GFXButtonBar]
  final GFXButtonBar? buttonBar;

  /// How the image should be inscribed into the box.
  /// The default is [BoxFit.scaleDown] if centerSlice is null, and
  /// [BoxFit.fill] if centerSlice is not null.
  /// [boxFit] for only [GFXImageOverlay]
  final BoxFit? boxFit;

  /// A color filter to apply to the image before painting it.
  final ColorFilter? colorFilter;

  /// The corners of this [GFXCard] are rounded by this [BorderRadius].
  final BorderRadiusGeometry? borderRadius;

  /// A border to draw above the [GFXCard].
  final Border? border;
